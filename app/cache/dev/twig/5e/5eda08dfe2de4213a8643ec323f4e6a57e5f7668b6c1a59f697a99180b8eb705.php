...
class __TwigTemplate_86743e38126db2d2a7f6722f30647bb54469ec18ee2e9b7561ecc6e8ad4820e3 extends Twig_Template
{
    ...
    {
        $__internal_1f0662648319e5df2e3e66c7105e583c09055c407e4377e45973d1e76e4a4a46 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_1f0662648319e5df2e3e66c7105e583c09055c407e4377e45973d1e76e4a4a46->enter($__internal_1f0662648319e5df2e3e66c7105e583c09055c407e4377e45973d1e76e4a4a46_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "TwigBundle:Exception:exception.html.twig"));
    ...
    <div class=\"block-exception-detected clear-fix\">
        ...
        <div class=\"text-exception\">
            ...
            <h1>";
        // line 11
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\CodeExtension')->formatFileFromText(nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 11, $this->getSourceContext()); })()), "message", array()), "html", null, true)));
        echo "</h1>

            <div>
                <strong>";
        // line 14
        echo twig_escape_filter($this->env, (isset($context["status_code"]) || array_key_exists("status_code", $context) ? $context["status_code"] : (function () { throw new Twig_Error_Runtime('Variable "status_code" does not exist.', 14, $this->getSourceContext()); })()), "html", null, true);
        echo "</strong> ";
        echo twig_escape_filter($this->env, (isset($context["status_text"]) || array_key_exists("status_text", $context) ? $context["status_text"] : (function () { throw new Twig_Error_Runtime('Variable "status_text" does not exist.', 14, $this->getSourceContext()); })()), "html", null, true);
        echo " - ";
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\CodeExtension')->abbrClass(twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 14, $this->getSourceContext()); })()), "class", array()));
        echo "
            </div>

            ";
        // line 17
        $context["previous_count"] = twig_length_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 17, $this->getSourceContext()); })()), "allPrevious", array()));
        // line 18
        echo "            ";
        if ((isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new Twig_Error_Runtime('Variable "previous_count" does not exist.', 18, $this->getSourceContext()); })())) {
            // line 19
            echo "                <div class=\"linked\"><span><strong>";
            echo twig_escape_filter($this->env, (isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new Twig_Error_Runtime('Variable "previous_count" does not exist.', 19, $this->getSourceContext()); })()), "html", null, true);
            echo "</strong> linked Exception";
            echo ((((isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new Twig_Error_Runtime('Variable "previous_count" does not exist.', 19, $this->getSourceContext()); })()) > 1)) ? ("s") : (""));
            echo ":</span>
                    <ul>
                        ";
            // line 21
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 21, $this->getSourceContext()); })()), "allPrevious", array()));
...
";
        // line 37
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 37, $this->getSourceContext()); })()), "toarray", array()));
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 38
            echo "    ";
            $this->loadTemplate("@Twig/Exception/traces.html.twig", "TwigBundle:Exception:exception.html.twig", 38)->display(array("exception" => $context["e"], "position" => $context["position"], "count" => (isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new Twig_Error_Runtime('Variable "previous_count" does not exist.', 38, $this->getSourceContext()); })())));
        }
        $_parent = $context['_parent'];
...
";
        // line 41
        if ((isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 41, $this->getSourceContext()); })())) {
            // line 42
        ...
        <div class=\"logs clear-fix\">
            ...
            ";
            // line 54
            if (twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 54, $this->getSourceContext()); })()), "counterrors", array())) {
                // line 55
                echo "                <div class=\"error-count\">
                    <span>
                        ";
                // line 57
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 57, $this->getSourceContext()); })()), "counterrors", array()), "html", null, true);
                echo " error";
                echo (((twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 57, $this->getSourceContext()); })()), "counterrors", array()) > 1)) ? ("s") : (""));
                echo "
                    </span>
                </div>
            ";
        ...
        <div id=\"logs\">
            ";
            // line 64
            $this->loadTemplate("@Twig/Exception/logs.html.twig", "TwigBundle:Exception:exception.html.twig", 64)->display(array("logs" => twig_get_attribute($this->env, $this->getSourceContext(), (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new Twig_Error_Runtime('Variable "logger" does not exist.', 64, $this->getSourceContext()); })()), "logs", array())));
            // line 65
            echo "        </div>
    </div>
";
...
";
        // line 69
        if ((isset($context["currentContent"]) || array_key_exists("currentContent", $context) ? $context["currentContent"] : (function () { throw new Twig_Error_Runtime('Variable "currentContent" does not exist.', 69, $this->getSourceContext()); })())) {
            // line 70
            echo "    <div class=\"block\">
        ";
            // line 71
        ...
        <div id=\"output-content\" style=\"display: none\">
            ";
            // line 82
            echo twig_escape_filter($this->env, (isset($context["currentContent"]) || array_key_exists("currentContent", $context) ? $context["currentContent"] : (function () { throw new Twig_Error_Runtime('Variable "currentContent" does not exist.', 82, $this->getSourceContext()); })()), "html", null, true);
            echo "
        </div>
...
";
        // line 89
        $this->loadTemplate("@Twig/Exception/traces_text.html.twig", "TwigBundle:Exception:exception.html.twig", 89)->display(array("exception" => (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 89, $this->getSourceContext()); })())));
        // line 90
        echo "
...
";
        ...
        $__internal_1f0662648319e5df2e3e66c7105e583c09055c407e4377e45973d1e76e4a4a46->leave($__internal_1f0662648319e5df2e3e66c7105e583c09055c407e4377e45973d1e76e4a4a46_prof);
...
//]]></script>
", "TwigBundle:Exception:exception.html.twig", "/var/www/html/scv/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/exception.html.twig");
    }
}
